...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ProposalInfo = __webpack_require__(160);

	var _ProposalInfo2 = _interopRequireDefault(_ProposalInfo);

	var _Segments = __webpack_require__(161);

	var _Segments2 = _interopRequireDefault(_Segments);

	var _addButton = __webpack_require__(162);
	...
	var App = function (_Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function addMore() {
	      ...
	      Segments.push(_react2.default.createElement(_Segments2.default, null));
	      this.setState({ Segments: Segments });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      var listItems = this.state.Segments.map(function (seg) {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(_ProposalInfo2.default, null)
	        ),
	        _react2.default.createElement(
	          'div',
	          null,
	        ...
	        _react2.default.createElement(
	          'div',
	          null,
	          _react2.default.createElement(_addButton2.default, { onAddButtonClicked: this.addMore.bind(this) })
	        )
	      );
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ProposalInfo = function (_Component) {
	  _inherits(ProposalInfo, _Component);

	  function ProposalInfo(props) {
	    _classCallCheck(this, ProposalInfo);

	    var _this = _possibleConstructorReturn(this, (ProposalInfo.__proto__ || Object.getPrototypeOf(ProposalInfo)).call(this, props));

	    _this.state = { title: '', destination: '', date: '' };
	    return _this;
	  }

	  _createClass(ProposalInfo, [{
	    key: 'render',
	    value: function render() {
	      var _this2 = this;
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'td',
	                { className: 'tds' },
	                _react2.default.createElement('input', { className: 'formInput', value: this.state.title,
	                  onChange: function onChange(event) {
	                    return _this2.onInputChange('title', event.target.value);
	                  } })
	              )
	            ),
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'td',
	                { className: 'tds' },
	                _react2.default.createElement('input', { className: 'formInput', value: this.state.destination,
	                  onChange: function onChange(event) {
	                    return _this2.onInputChange('destination', event.target.value);
	                  } })
	              )
	            ),
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'td',
	                { className: 'tds' },
	                _react2.default.createElement('input', { className: 'formInput', value: this.state.date,
	                  onChange: function onChange(event) {
	                    return _this2.onInputChange('date', event.target.value);
	                  } })
	              )
	            )
	          )
	    ...
	    key: 'onInputChange',
	    value: function onInputChange(type, term) {
	      if (type == 'title') this.setState({ 'title': term });else if (type == 'destination') this.setState({ 'destination': term });else {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Segment = function (_Component) {
	  ...
	  function Segment(props) {
	    ...
	    return _possibleConstructorReturn(this, (Segment.__proto__ || Object.getPrototypeOf(Segment)).call(this, props));
	  }
	  ...
	  _createClass(Segment, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          "button",
	          { type: "button", className: "guibutton" },
	          "Add Travel"
	        )
	      );
	    }
	...
	var AddButton = function (_Component) {
	  ...
	  _createClass(AddButton, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        "button",
	        { type: "button", className: "guibutton", onClick: function onClick(event) {
	            return _this2.onButtonClicked();
	          } },
	        "Add Segment"
	      );
	    }
